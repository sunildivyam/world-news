...
} from "../parsers/newsapi-ai.parser";
import { AppError } from "@/types/AppError";

export class NewsApiAiProvider implements NewsProvider {
  name: string = "NewsApiAI";
  private baseUrl = process.env.NEWSAPIAI_API_URL!;
  private apiKey = process.env.NEWSAPIAI_API_KEY!;
